  ...
  return (
    ...
    <>
      ...
      <div className="h-screen items-center bg-gray-200 text-gray-900 flex justify-center">
        ...
        <div className="max-w-screen-xl m-0 sm:m-10 sm:rounded-lg flex justify-center flex-1 h-fit rounded-xl overflow-hidden shadow-lg">
          ...
          /> */}
            ...
            <div className="mt-6 flex flex-col items-center">
              <h1 className="text-2xl xl:text-3xl font-bold">Log In</h1>
